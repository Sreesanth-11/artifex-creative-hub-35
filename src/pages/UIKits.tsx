...
const UIKits = () => {
  ...
  const uiKits = Array.from({ length: 24 }, (_, i) => ({
    id: i + 1,
    title: `UI Kit ${i + 1}`,
                  ...
                  <CardContent className="p-0">
                    <div className="relative overflow-hidden rounded-t-lg">
                      ...
                      <div className="absolute bottom-3 left-3">
                        <Badge className="bg-secondary/90 text-secondary-foreground flex items-center gap-1">
                          <Layers className="w-3 h-3" />
                          {uiKit.components} Components
                        </Badge>
                      </div>
