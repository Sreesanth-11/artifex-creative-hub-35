          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              <h1 className="text-3xl md:text-4xl font-bold">
                Browse <span className="bg-gradient-primary bg-clip-text text-transparent">Creative Assets</span>
              </h1>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1">
              ...
              <div className={`grid gap-6 ${
                ...
                {designs.map((design) => (
                  <Card key={design.id} className="group cursor-pointer bg-card border-border hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/20">
